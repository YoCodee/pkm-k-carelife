        ...
        <div className="max-w-[900px] mx-auto">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-2">
              ...
              <Link href="/about" className="w-11 h-11 bg-[#FFB6B6] rounded-[14px] flex items-center justify-center border-2 border-[#1A1A1A] shadow-[2px_2px_0_#1A1A1A] hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-[1px_1px_0_#1A1A1A] transition-all overflow-hidden">
                <img src="https://api.dicebear.com/7.x/notionists/svg?seed=CareLife&backgroundColor=ffdfbf" alt="Profile" className="w-full h-full object-cover rounded-[12px]" />
              </Link>
            </div>
          </div>
        </div>
      ...
      <main className="px-6 md:px-10 lg:px-16 py-6 flex flex-col gap-6 max-w-[900px] mx-auto w-full relative z-10">
        ...
        <div className="flex items-center justify-center py-6 md:py-10">
          <div className="relative w-[260px] h-[200px] md:w-[320px] md:h-[240px] flex justify-center items-center">
            ...
            <motion.div
              initial={false}
              animate={isReady ? { rotate: -12, x: -60, y: 10, opacity: 1 } : { rotate: 0, x: 0, y: 20, opacity: 0 }}
            ...
            >
              <div className="w-full h-full flex flex-col items-center justify-center p-4">
                ...
                <p className="text-[#1A1A1A] font-black text-xs text-center">Dunia Visual</p>
              </div>
            </motion.div>

            {/* Back card — right (pink) */}
            <motion.div
              initial={false}
              animate={isReady ? { rotate: 10, x: 60, y: 5, opacity: 1 } : { rotate: 0, x: 0, y: 20, opacity: 0 }}
            ...
            >
              <div className="w-full h-full flex flex-col items-center justify-center p-4">
                ...
                <p className="text-[#1A1A1A] font-black text-xs text-center">Dunia Ceria</p>
              </div>
            </motion.div>

            {/* Front card — center (teal) */}
            <motion.div
              initial={false}
              animate={isReady ? { y: 0, opacity: 1, scale: 1 } : { y: 30, opacity: 0, scale: 0.9 }}
            ...
            >
              <div className="w-full h-full flex flex-col items-center justify-center p-5 cursor-pointer">
                ...
                <p className="text-white font-black text-sm text-center">Dunia Suara</p>
                <p className="text-white/70 font-bold text-[10px] text-center mt-1">CareLife</p>
              </div>
            </motion.div>
          </div>
        </div>
        ...
        <div className="text-center mb-2">
          <h2 className="text-lg font-black text-[#1A1A1A]">Kategori Belajar</h2>
        ...
        <div className="mt-4 mb-8 bg-white rounded-[24px] p-6 md:p-8 border-2 border-[#1A1A1A] shadow-[4px_4px_0_#1A1A1A] relative overflow-hidden">
          ...
          <div className="relative z-10 md:flex md:items-center md:gap-6">
            <div className="flex-1">
              ...
              <h3 className="text-lg md:text-xl font-black mb-2 leading-tight text-[#1A1A1A]">3 Mode Belajar<br/>Untuk Semua ABK</h3>
              <p className="text-[#6B7280] font-bold text-xs leading-relaxed">
                Visual, Audio, dan Bahasa Isyarat — disesuaikan untuk tunanetra, tunarungu & tunagrahita.
              </p>
            </div>
